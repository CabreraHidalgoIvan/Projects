...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private ?\DateTimeInterface $ultimoAcces = null;
    ...
    public function getUltimoAcces(): ?\DateTimeInterface
    {
        return $this->ultimoAcces;
    }

    public function setUltimoAcces(?\DateTimeInterface $ultimoAcces): self
    {
        $this->ultimoAcces = $ultimoAcces;
